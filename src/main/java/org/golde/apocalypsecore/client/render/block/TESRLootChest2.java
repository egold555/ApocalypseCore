...
public class TESRLootChest2 extends TESRLootChest {
	...
	@Override
	public void render(TIleEntityLootChest te, double x, double y, double z, float partialTicks, int destroyStage,
			float alpha) {
		...
		for (int j = 0; j < i; ++j)
		{
			...
			bufferbuilder.pos(x + 0.18D, y + (double)f, z + 0.82D).color(f3, f4, f5, 1.0F).endVertex();
			bufferbuilder.pos(x + 0.82D, y + (double)f, z + 0.82D).color(f3, f4, f5, 1.0F).endVertex();
			bufferbuilder.pos(x + 0.82D, y + (double)f, z + 0.18).color(f3, f4, f5, 1.0F).endVertex();
			bufferbuilder.pos(x + 0.18D, y + (double)f, z + 0.18).color(f3, f4, f5, 1.0F).endVertex();
