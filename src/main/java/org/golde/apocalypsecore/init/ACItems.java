...
public class ACItems {
	...
	public static _ACItemFood cd_sprite;
	public static _ACItem cd_sprite_empty;
	...
	public static void registerItems(RegistryEvent.Register<Item> event) {
		...
		event.getRegistry().register(cd_sprite = new _ACItemFood("sprite", EnumAnimation.DRINK).setReturnItem(cd_sprite_empty));
		event.getRegistry().register(cd_sprite_empty = new _ACItem("sprite_empty"));
