...
public class BlockColoredLamp extends _ACBlock {

	public static final PropertyDirection FACING = BlockDirectional.FACING;
	protected static final AxisAlignedBB LAMP_AAB = new AxisAlignedBB(0.375D, 0.71875D, 0.375D, 0.625D, 1.0D, 0.625D);

	public BlockColoredLamp(EnumDyeColor c, boolean caged) {
		super("lamp_" + c.getName().toLowerCase() + (caged ? "_caged" : ""), Material.IRON);
