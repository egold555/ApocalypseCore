...
public class FeatureFood extends Feature {
	...
	public void registerItems() {
		...
		registerItem(candybar = new _ACItemFood("candybar", EnumAnimation.EAT, 6));
		...
		registerItem(cereal = new _ACItemFood("cereal", EnumAnimation.EAT, 10));
		registerItem(cerealemerald = new _ACItemFood("cerealemerald", EnumAnimation.EAT, 10));
		registerItem(cerealflakes = new _ACItemFood("cerealflakes", EnumAnimation.EAT, 10));
		registerItem(cerealnutty = new _ACItemFood("cerealnutty", EnumAnimation.EAT, 10));
