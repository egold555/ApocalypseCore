...
public class RenderEntityMolotovCocktail extends Render<EntityMolotovCocktail> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderEntityMolotovCocktail(RenderManager renderManager, Item itemIn) {
		super(renderManager);
		this.item = itemIn;
    ...
    public void doRender(EntityMolotovCocktail entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.itemRenderer.renderItem(new ItemStack(item), ItemCameraTransforms.TransformType.GROUND);
